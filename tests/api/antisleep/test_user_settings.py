...
class TestUserSettings:
    ...
    def test_update_user_settings_valid_name(self, cluster, get_token):
        ...
        response = cluster.user_settings.put_settings(get_token, params=payload)
    ...
    def test_update_user_settings_missing_name(self, cluster, get_token):
        ...
        response = cluster.user_settings.put_settings(get_token, params=payload, check_ok=False)
